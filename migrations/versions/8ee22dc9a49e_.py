...
Revision ID: 8ee22dc9a49e
Revises: 
Create Date: 2018-09-06 15:04:54.581557
...
def upgrade():
    ...
    sa.Column('id', postgresql.UUID(as_uuid=True), server_default='uuid_generate_v4()', nullable=False),
